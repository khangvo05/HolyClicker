...
A simple, intuitive yet extensive auto typing and auto clicking script writing application for automating your boring tasks.
...
- **Simple, human-intuitive scripting system to customize your desired clicking routine. Those commands offer the following utilities:**
    ...
    - Type text.
    - Press down and release buttons.
    - Press down and release mouse buttons.
    ...
    - Checking for an image's appearance on the screen to execute commands.
